...
class App {
  ...
  _renderWorkout(workout) {
    ...
    html += `<button class="workout__edit">Edit</button>
  ...
  _deleteWorkout(id, workoutEl) {
    ...
    this.#map.eachLayer((layer) => {
      if (layer instanceof L.Marker && layer._popup._content.includes(id)) {
